...
var PropertiesDefinitions = []property{
	...
	{AwlessLabel: "Addresses", RDFLabel: fmt.Sprintf("%s:addresses", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsList, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "AmazonSideAsn", RDFLabel: fmt.Sprintf("%s:amazonSideAsn", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	{AwlessLabel: "Application", RDFLabel: fmt.Sprintf("%s:application", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "AssociationState", RDFLabel: fmt.Sprintf("%s:associationState", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "AutomaticFailover", RDFLabel: fmt.Sprintf("%s:automaticFailover", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Bandwidth", RDFLabel: fmt.Sprintf("%s:bandwidth", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "BrokerCount", RDFLabel: fmt.Sprintf("%s:brokerCount", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	...
	{AwlessLabel: "CacheNodeType", RDFLabel: fmt.Sprintf("%s:cacheNodeType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Capacity", RDFLabel: fmt.Sprintf("%s:capacity", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	...
	{AwlessLabel: "ComputePlatform", RDFLabel: fmt.Sprintf("%s:computePlatform", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "ConnectedDevice", RDFLabel: fmt.Sprintf("%s:connectedDevice", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "ConnectedLink", RDFLabel: fmt.Sprintf("%s:connectedLink", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "ConnectionId", RDFLabel: fmt.Sprintf("%s:connectionId", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "CoreNetwork", RDFLabel: fmt.Sprintf("%s:coreNetwork", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Database", RDFLabel: fmt.Sprintf("%s:database", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "DBName", RDFLabel: fmt.Sprintf("%s:dbName", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "DeploymentConfig", RDFLabel: fmt.Sprintf("%s:deploymentConfig", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "DeploymentMode", RDFLabel: fmt.Sprintf("%s:deploymentMode", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "DeviceId", RDFLabel: fmt.Sprintf("%s:deviceId", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "DirectConnectGateway", RDFLabel: fmt.Sprintf("%s:directConnectGateway", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "DNSName", RDFLabel: fmt.Sprintf("%s:dnsName", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "EdgeLocation", RDFLabel: fmt.Sprintf("%s:edgeLocation", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "EngineType", RDFLabel: fmt.Sprintf("%s:engineType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "EventBus", RDFLabel: fmt.Sprintf("%s:eventBus", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "ExecutionMode", RDFLabel: fmt.Sprintf("%s:executionMode", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Frequency", RDFLabel: fmt.Sprintf("%s:frequency", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "GlobalNetwork", RDFLabel: fmt.Sprintf("%s:globalNetwork", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "GlueVersion", RDFLabel: fmt.Sprintf("%s:glueVersion", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Health", RDFLabel: fmt.Sprintf("%s:health", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "HostInstanceType", RDFLabel: fmt.Sprintf("%s:hostInstanceType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "InputParameters", RDFLabel: fmt.Sprintf("%s:inputParameters", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "InstanceCount", RDFLabel: fmt.Sprintf("%s:instanceCount", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	...
	{AwlessLabel: "KafkaVersion", RDFLabel: fmt.Sprintf("%s:kafkaVersion", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "LastExecution", RDFLabel: fmt.Sprintf("%s:lastExecution", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdDateTime},
	{AwlessLabel: "LastModified", RDFLabel: fmt.Sprintf("%s:lastModified", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdDateTime},
	...
	{AwlessLabel: "LagId", RDFLabel: fmt.Sprintf("%s:lagId", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "LinkId", RDFLabel: fmt.Sprintf("%s:linkId", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "LocationURI", RDFLabel: fmt.Sprintf("%s:locationUri", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "Locked", RDFLabel: fmt.Sprintf("%s:locked", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdBoolean},
	...
	{AwlessLabel: "ManagedBy", RDFLabel: fmt.Sprintf("%s:managedBy", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "MasterUsername", RDFLabel: fmt.Sprintf("%s:masterUsername", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "MaxRetentionDays", RDFLabel: fmt.Sprintf("%s:maxRetentionDays", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	...
	{AwlessLabel: "MemberClusters", RDFLabel: fmt.Sprintf("%s:memberClusters", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsList, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Model", RDFLabel: fmt.Sprintf("%s:model", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "NodeCount", RDFLabel: fmt.Sprintf("%s:nodeCount", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	{AwlessLabel: "NodeType", RDFLabel: fmt.Sprintf("%s:nodeType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "PartnerName", RDFLabel: fmt.Sprintf("%s:partnerName", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Pattern", RDFLabel: fmt.Sprintf("%s:pattern", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "PeerOwner", RDFLabel: fmt.Sprintf("%s:peerOwner", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "PeerRegion", RDFLabel: fmt.Sprintf("%s:peerRegion", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "PeerVpc", RDFLabel: fmt.Sprintf("%s:peerVpc", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "PeeringType", RDFLabel: fmt.Sprintf("%s:peeringType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "PipelineType", RDFLabel: fmt.Sprintf("%s:pipelineType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "PlatformDetails", RDFLabel: fmt.Sprintf("%s:platformDetails", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "Policy", RDFLabel: fmt.Sprintf("%s:policy", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "ReplicationGroup", RDFLabel: fmt.Sprintf("%s:replicationGroup", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "ScheduleExpression", RDFLabel: fmt.Sprintf("%s:scheduleExpression", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Scope", RDFLabel: fmt.Sprintf("%s:scope", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "SendingEnabled", RDFLabel: fmt.Sprintf("%s:sendingEnabled", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdBoolean},
	{AwlessLabel: "ServiceCount", RDFLabel: fmt.Sprintf("%s:serviceCount", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	{AwlessLabel: "ServiceName", RDFLabel: fmt.Sprintf("%s:serviceName", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "ShardCount", RDFLabel: fmt.Sprintf("%s:shardCount", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	...
	{AwlessLabel: "SerialNumber", RDFLabel: fmt.Sprintf("%s:serialNumber", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "SiteId", RDFLabel: fmt.Sprintf("%s:siteId", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "SolutionStack", RDFLabel: fmt.Sprintf("%s:solutionStack", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "SourceIdentifier", RDFLabel: fmt.Sprintf("%s:sourceIdentifier", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "StorageCapacity", RDFLabel: fmt.Sprintf("%s:storageCapacity", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	...
	{AwlessLabel: "StreamMode", RDFLabel: fmt.Sprintf("%s:streamMode", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "SubnetGroup", RDFLabel: fmt.Sprintf("%s:subnetGroup", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "TransitGateway", RDFLabel: fmt.Sprintf("%s:transitGateway", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "VerificationStatus", RDFLabel: fmt.Sprintf("%s:verificationStatus", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Vendor", RDFLabel: fmt.Sprintf("%s:vendor", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "VersionLabel", RDFLabel: fmt.Sprintf("%s:versionLabel", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "VirtualGateway", RDFLabel: fmt.Sprintf("%s:virtualGateway", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	{AwlessLabel: "Vlan", RDFLabel: fmt.Sprintf("%s:vlan", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	...
	{AwlessLabel: "WorkerType", RDFLabel: fmt.Sprintf("%s:workerType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	...
	// New properties for EKS, DynamoDB, Secrets Manager, KMS, API Gateway, SSM, EFS
	...
	{AwlessLabel: "KubernetesVersion", RDFLabel: fmt.Sprintf("%s:kubernetesVersion", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "RoleArn", RDFLabel: fmt.Sprintf("%s:roleArn", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "ScalingConfig", RDFLabel: fmt.Sprintf("%s:scalingConfig", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "TableClass", RDFLabel: fmt.Sprintf("%s:tableClass", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "ItemCount", RDFLabel: fmt.Sprintf("%s:itemCount", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	{AwlessLabel: "SizeBytes", RDFLabel: fmt.Sprintf("%s:sizeBytes", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	{AwlessLabel: "KeySchema", RDFLabel: fmt.Sprintf("%s:keySchema", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsList, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "ReadCapacity", RDFLabel: fmt.Sprintf("%s:readCapacity", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	{AwlessLabel: "WriteCapacity", RDFLabel: fmt.Sprintf("%s:writeCapacity", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	{AwlessLabel: "RotationEnabled", RDFLabel: fmt.Sprintf("%s:rotationEnabled", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdBoolean},
	{AwlessLabel: "RotationInterval", RDFLabel: fmt.Sprintf("%s:rotationInterval", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdInt},
	{AwlessLabel: "LastAccessed", RDFLabel: fmt.Sprintf("%s:lastAccessed", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdDateTime},
	{AwlessLabel: "LastRotated", RDFLabel: fmt.Sprintf("%s:lastRotated", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdDateTime},
	{AwlessLabel: "KeyManager", RDFLabel: fmt.Sprintf("%s:keyManager", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "KeyUsage", RDFLabel: fmt.Sprintf("%s:keyUsage", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "KeyState", RDFLabel: fmt.Sprintf("%s:keyState", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "Origin", RDFLabel: fmt.Sprintf("%s:origin", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "ApiProtocol", RDFLabel: fmt.Sprintf("%s:apiProtocol", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "RouteKey", RDFLabel: fmt.Sprintf("%s:routeKey", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "Target", RDFLabel: fmt.Sprintf("%s:target", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "StageName", RDFLabel: fmt.Sprintf("%s:stageName", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "DeploymentID", RDFLabel: fmt.Sprintf("%s:deploymentID", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "AutoDeploy", RDFLabel: fmt.Sprintf("%s:autoDeploy", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdBoolean},
	{AwlessLabel: "ParameterType", RDFLabel: fmt.Sprintf("%s:parameterType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "DataType", RDFLabel: fmt.Sprintf("%s:dataType", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "Tier", RDFLabel: fmt.Sprintf("%s:tier", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "PerformanceMode", RDFLabel: fmt.Sprintf("%s:performanceMode", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
	{AwlessLabel: "ThroughputMode", RDFLabel: fmt.Sprintf("%s:throughputMode", rdf.CloudNS), RDFType: rdf.RdfProperty, RdfsDefinedBy: rdf.RdfsLiteral, RdfsDataType: rdf.XsdString},
