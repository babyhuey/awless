...
func TestUpgradeMessaging(t *testing.T) {
	...
	// Archive name follows GoReleaser's template:
	// {{ .ProjectName }}_{{ .Version }}_{{ .Os }}_{{ .Arch }}
	exp := fmt.Sprintf("New version 1000.0.0 available. Checkout the latest features at https://github.com/bootswithdefer/awless/blob/master/CHANGELOG.md\nRun `wget https://github.com/bootswithdefer/awless/releases/download/1000.0.0/awless_1000.0.0_%s_%s.tar.gz`\n", runtime.GOOS, runtime.GOARCH)
