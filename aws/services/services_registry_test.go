...
func TestNewServicesAreRegistered(t *testing.T) {
	...
	for _, want := range []string{
		...
		"ssm", "efs", "cloudtrail", "cloudwatchlogs", "elasticache", "eventbridge", "stepfunctions", "waf", "configservice", "kinesis", "redshift", "codepipeline", "codebuild", "beanstalk", "codedeploy", "glue", "ses", "cognito",
	} {
