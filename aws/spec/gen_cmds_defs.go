...
var DriverSupportedActions = map[string][]string{
	...
	"update":       []string{"bucket", "cachecluster", "cachesubnetgroup", "classicloadbalancer", "containertask", "distribution", "eventrule", "image", "instance", "loggroup", "loginprofile", "policy", "record", "s3object", "scalinggroup", "secret", "securitygroup", "ssmparameter", "stack", "statemachine", "subnet", "targetgroup"},
}
