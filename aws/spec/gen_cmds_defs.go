...
var DriverSupportedActions = map[string][]string{
	...
	"update":       []string{"application", "bucket", "buildproject", "cachecluster", "cachesubnetgroup", "classicloadbalancer", "configrule", "containertask", "distribution", "environment", "eventrule", "image", "instance", "ipset", "loggroup", "loginprofile", "policy", "record", "redshiftcluster", "s3object", "scalinggroup", "secret", "securitygroup", "ssmparameter", "stack", "statemachine", "stream", "subnet", "targetgroup"},
}
