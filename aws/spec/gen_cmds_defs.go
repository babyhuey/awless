...
var DriverSupportedActions = map[string][]string{
	...
	"start":        []string{"alarm", "containertask", "database", "eventrule", "execution", "instance", "pipeline", "trail"},
	"stop":         []string{"alarm", "containertask", "database", "eventrule", "execution", "instance", "pipeline", "trail"},
	"update":       []string{"bucket", "cachecluster", "cachesubnetgroup", "classicloadbalancer", "configrule", "containertask", "distribution", "eventrule", "image", "instance", "ipset", "loggroup", "loginprofile", "policy", "record", "redshiftcluster", "s3object", "scalinggroup", "secret", "securitygroup", "ssmparameter", "stack", "statemachine", "stream", "subnet", "targetgroup"},
}
