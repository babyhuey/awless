...
var DriverSupportedActions = map[string][]string{
	...
	"create":       []string{"accesskey", "alarm", "apigateway", "apigatewayroute", "apigatewaystage", "application", "appscalingpolicy", "appscalingtarget", "bucket", "buildproject", "cachecluster", "cachesubnetgroup", "certificate", "classicloadbalancer", "configrule", "containercluster", "database", "dbsubnetgroup", "distribution", "dynamodbtable", "ekscluster", "eksnodegroup", "elasticip", "environment", "eventbus", "eventrule", "filesystem", "function", "group", "image", "instance", "instanceprofile", "internetgateway", "ipset", "keypair", "launchconfiguration", "listener", "loadbalancer", "loggroup", "loginprofile", "mfadevice", "natgateway", "networkinterface", "pipeline", "policy", "queue", "record", "redshiftcluster", "redshiftsubnetgroup", "replicationgroup", "repository", "role", "route", "routetable", "rulegroup", "s3object", "scalinggroup", "scalingpolicy", "secret", "securitygroup", "snapshot", "ssmparameter", "stack", "statemachine", "stream", "subnet", "subscription", "tag", "targetgroup", "topic", "trail", "transitgateway", "transitgatewayattachment", "transitgatewayroutetable", "user", "volume", "vpc", "vpcendpoint", "webacl", "zone"},
	"delete":       []string{"accesskey", "alarm", "apigateway", "apigatewayroute", "apigatewaystage", "application", "appscalingpolicy", "appscalingtarget", "bucket", "buildproject", "cachecluster", "cachesubnetgroup", "certificate", "classicloadbalancer", "configrule", "containercluster", "containertask", "database", "dbsubnetgroup", "distribution", "dynamodbtable", "ekscluster", "eksnodegroup", "elasticip", "environment", "eventbus", "eventrule", "filesystem", "function", "group", "image", "instance", "instanceprofile", "internetgateway", "ipset", "keypair", "launchconfiguration", "listener", "loadbalancer", "loggroup", "loginprofile", "mfadevice", "natgateway", "networkinterface", "pipeline", "policy", "queue", "record", "redshiftcluster", "redshiftsubnetgroup", "replicationgroup", "repository", "role", "route", "routetable", "rulegroup", "s3object", "scalinggroup", "scalingpolicy", "secret", "securitygroup", "snapshot", "ssmparameter", "stack", "statemachine", "stream", "subnet", "subscription", "tag", "targetgroup", "topic", "trail", "transitgateway", "transitgatewayattachment", "transitgatewayroutetable", "user", "volume", "vpc", "vpcendpoint", "webacl", "zone"},
	...
	"stop":         []string{"alarm", "buildproject", "containertask", "database", "eventrule", "execution", "instance", "pipeline", "trail"},
