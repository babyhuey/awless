...
var DriverSupportedActions = map[string][]string{
	...
	"create":       []string{"accesskey", "alarm", "apigateway", "apigatewayroute", "apigatewaystage", "appscalingpolicy", "appscalingtarget", "bucket", "buildproject", "cachecluster", "cachesubnetgroup", "certificate", "classicloadbalancer", "configrule", "containercluster", "database", "dbsubnetgroup", "distribution", "dynamodbtable", "ekscluster", "eksnodegroup", "elasticip", "eventbus", "eventrule", "filesystem", "function", "group", "image", "instance", "instanceprofile", "internetgateway", "ipset", "keypair", "launchconfiguration", "listener", "loadbalancer", "loggroup", "loginprofile", "mfadevice", "natgateway", "networkinterface", "policy", "queue", "record", "redshiftcluster", "redshiftsubnetgroup", "replicationgroup", "repository", "role", "route", "routetable", "s3object", "scalinggroup", "scalingpolicy", "secret", "securitygroup", "snapshot", "ssmparameter", "stack", "statemachine", "stream", "subnet", "subscription", "tag", "targetgroup", "topic", "trail", "user", "volume", "vpc", "zone"},
	"delete":       []string{"accesskey", "alarm", "apigateway", "apigatewayroute", "apigatewaystage", "appscalingpolicy", "appscalingtarget", "bucket", "buildproject", "cachecluster", "cachesubnetgroup", "certificate", "classicloadbalancer", "configrule", "containercluster", "containertask", "database", "dbsubnetgroup", "distribution", "dynamodbtable", "ekscluster", "eksnodegroup", "elasticip", "eventbus", "eventrule", "filesystem", "function", "group", "image", "instance", "instanceprofile", "internetgateway", "ipset", "keypair", "launchconfiguration", "listener", "loadbalancer", "loggroup", "loginprofile", "mfadevice", "natgateway", "networkinterface", "pipeline", "policy", "queue", "record", "redshiftcluster", "redshiftsubnetgroup", "replicationgroup", "repository", "role", "route", "routetable", "s3object", "scalinggroup", "scalingpolicy", "secret", "securitygroup", "snapshot", "ssmparameter", "stack", "statemachine", "stream", "subnet", "subscription", "tag", "targetgroup", "topic", "trail", "user", "volume", "vpc", "zone"},
	...
	"update":       []string{"bucket", "buildproject", "cachecluster", "cachesubnetgroup", "classicloadbalancer", "configrule", "containertask", "distribution", "eventrule", "image", "instance", "ipset", "loggroup", "loginprofile", "policy", "record", "redshiftcluster", "s3object", "scalinggroup", "secret", "securitygroup", "ssmparameter", "stack", "statemachine", "stream", "subnet", "targetgroup"},
}
