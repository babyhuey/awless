...
var awsResourcesDef = map[string]map[string]*propertyTransform{
	...
	// ElastiCache
	cloud.CacheCluster: {
		properties.ID:               {name: "CacheClusterId", transform: extractValueFn},
		properties.Arn:              {name: "ARN", transform: extractValueFn},
		properties.State:            {name: "CacheClusterStatus", transform: extractValueFn},
		properties.Engine:           {name: "Engine", transform: extractValueFn},
		properties.EngineVersion:    {name: "EngineVersion", transform: extractValueFn},
		properties.CacheNodeType:    {name: "CacheNodeType", transform: extractValueFn},
		properties.NodeCount:        {name: "NumCacheNodes", transform: extractValueFn},
		properties.Zone:             {name: "PreferredAvailabilityZone", transform: extractValueFn},
		properties.SubnetGroup:      {name: "CacheSubnetGroupName", transform: extractValueFn},
		properties.ReplicationGroup: {name: "ReplicationGroupId", transform: extractValueFn},
		properties.Created:          {name: "CacheClusterCreateTime", transform: extractTimeFn},
	},
	cloud.ReplicationGroup: {
		properties.ID:                {name: "ReplicationGroupId", transform: extractValueFn},
		properties.Arn:               {name: "ARN", transform: extractValueFn},
		properties.Description:       {name: "Description", transform: extractValueFn},
		properties.State:             {name: "Status", transform: extractValueFn},
		properties.Engine:            {name: "Engine", transform: extractValueFn},
		properties.CacheNodeType:     {name: "CacheNodeType", transform: extractValueFn},
		properties.ClusterEnabled:    {name: "ClusterEnabled", transform: extractValueFn},
		properties.AutomaticFailover: {name: "AutomaticFailover", transform: extractValueFn},
		properties.MultiAZ:           {name: "MultiAZ", transform: extractValueFn},
		properties.MemberClusters:    {name: "MemberClusters", transform: extractValueFn},
		properties.Created:           {name: "ReplicationGroupCreateTime", transform: extractTimeFn},
	},
	cloud.CacheSubnetGroup: {
		properties.Name:        {name: "CacheSubnetGroupName", transform: extractValueFn},
		properties.Arn:         {name: "ARN", transform: extractValueFn},
	...
	// Direct Connect
	cloud.DirectConnectConnection: {
		properties.Name:        {name: "ConnectionName", transform: extractValueFn},
		properties.State:       {name: "ConnectionState", transform: extractValueFn},
		properties.Bandwidth:   {name: "Bandwidth", transform: extractValueFn},
		properties.Location:    {name: "Location", transform: extractValueFn},
		properties.Vlan:        {name: "Vlan", transform: extractValueFn},
		properties.LagId:       {name: "LagId", transform: extractValueFn},
		properties.PartnerName: {name: "PartnerName", transform: extractValueFn},
		properties.Owner:       {name: "OwnerAccount", transform: extractValueFn},
		properties.Region:      {name: "Region", transform: extractValueFn},
	},
	cloud.DirectConnectVirtualInterface: {
		properties.Name:                 {name: "VirtualInterfaceName", transform: extractValueFn},
		properties.State:                {name: "VirtualInterfaceState", transform: extractValueFn},
		properties.Type:                 {name: "VirtualInterfaceType", transform: extractValueFn},
		properties.Vlan:                 {name: "Vlan", transform: extractValueFn},
		properties.ConnectionId:         {name: "ConnectionId", transform: extractValueFn},
		properties.DirectConnectGateway: {name: "DirectConnectGatewayId", transform: extractValueFn},
		properties.Location:             {name: "Location", transform: extractValueFn},
		properties.Owner:                {name: "OwnerAccount", transform: extractValueFn},
		properties.Region:               {name: "Region", transform: extractValueFn},
		properties.AmazonSideAsn:        {name: "AmazonSideAsn", transform: extractValueFn},
	},
	cloud.DirectConnectLag: {
		properties.Name:      {name: "LagName", transform: extractValueFn},
		properties.State:     {name: "LagState", transform: extractValueFn},
		properties.Bandwidth: {name: "ConnectionsBandwidth", transform: extractValueFn},
		properties.Location:  {name: "Location", transform: extractValueFn},
		properties.Owner:     {name: "OwnerAccount", transform: extractValueFn},
		properties.Region:    {name: "Region", transform: extractValueFn},
	},
	cloud.DirectConnectGateway: {
		properties.Name:          {name: "DirectConnectGatewayName", transform: extractValueFn},
		properties.State:         {name: "DirectConnectGatewayState", transform: extractValueFn},
		properties.AmazonSideAsn: {name: "AmazonSideAsn", transform: extractValueFn},
		properties.Owner:         {name: "OwnerAccount", transform: extractValueFn},
	},
	cloud.DirectConnectGatewayAssociation: {
		properties.AssociationState:     {name: "AssociationState", transform: extractValueFn},
		properties.DirectConnectGateway: {name: "DirectConnectGatewayId", transform: extractValueFn},
		properties.Owner:                {name: "DirectConnectGatewayOwnerAccount", transform: extractValueFn},
		properties.VirtualGateway:       {name: "VirtualGatewayId", transform: extractValueFn},
	},
	// Network Manager (Cloud WAN)
	cloud.GlobalNetwork: {
		properties.Arn:         {name: "GlobalNetworkArn", transform: extractValueFn},
		properties.State:       {name: "State", transform: extractValueFn},
		properties.Description: {name: "Description", transform: extractValueFn},
		properties.Created:     {name: "CreatedAt", transform: extractTimeFn},
	},
	cloud.CoreNetwork: {
		properties.Arn:           {name: "CoreNetworkArn", transform: extractValueFn},
		properties.State:         {name: "State", transform: extractValueFn},
		properties.Description:   {name: "Description", transform: extractValueFn},
		properties.GlobalNetwork: {name: "GlobalNetworkId", transform: extractValueFn},
		properties.Owner:         {name: "OwnerAccountId", transform: extractValueFn},
	},
	cloud.NetworkManagerSite: {
		properties.Arn:           {name: "SiteArn", transform: extractValueFn},
		properties.State:         {name: "State", transform: extractValueFn},
		properties.Description:   {name: "Description", transform: extractValueFn},
		properties.GlobalNetwork: {name: "GlobalNetworkId", transform: extractValueFn},
		properties.Created:       {name: "CreatedAt", transform: extractTimeFn},
	},
	cloud.NetworkManagerLink: {
		properties.Arn:           {name: "LinkArn", transform: extractValueFn},
		properties.State:         {name: "State", transform: extractValueFn},
		properties.Description:   {name: "Description", transform: extractValueFn},
		properties.Type:          {name: "Type", transform: extractValueFn},
		properties.GlobalNetwork: {name: "GlobalNetworkId", transform: extractValueFn},
		properties.SiteId:        {name: "SiteId", transform: extractValueFn},
		properties.Created:       {name: "CreatedAt", transform: extractTimeFn},
	},
	cloud.NetworkManagerDevice: {
		properties.Arn:           {name: "DeviceArn", transform: extractValueFn},
		properties.State:         {name: "State", transform: extractValueFn},
		properties.Description:   {name: "Description", transform: extractValueFn},
		properties.Type:          {name: "Type", transform: extractValueFn},
		properties.Model:         {name: "Model", transform: extractValueFn},
		properties.SerialNumber:  {name: "SerialNumber", transform: extractValueFn},
		properties.Vendor:        {name: "Vendor", transform: extractValueFn},
		properties.GlobalNetwork: {name: "GlobalNetworkId", transform: extractValueFn},
		properties.SiteId:        {name: "SiteId", transform: extractValueFn},
		properties.Created:       {name: "CreatedAt", transform: extractTimeFn},
	},
	cloud.NetworkManagerConnection: {
		properties.Arn:             {name: "ConnectionArn", transform: extractValueFn},
		properties.State:           {name: "State", transform: extractValueFn},
		properties.Description:     {name: "Description", transform: extractValueFn},
		properties.GlobalNetwork:   {name: "GlobalNetworkId", transform: extractValueFn},
		properties.DeviceId:        {name: "DeviceId", transform: extractValueFn},
		properties.ConnectedDevice: {name: "ConnectedDeviceId", transform: extractValueFn},
		properties.LinkId:          {name: "LinkId", transform: extractValueFn},
		properties.ConnectedLink:   {name: "ConnectedLinkId", transform: extractValueFn},
		properties.Created:         {name: "CreatedAt", transform: extractTimeFn},
	},
	cloud.NetworkManagerPeering: {
		properties.CoreNetwork:  {name: "CoreNetworkId", transform: extractValueFn},
		properties.Arn:          {name: "CoreNetworkArn", transform: extractValueFn},
		properties.State:        {name: "State", transform: extractValueFn},
		properties.PeeringType:  {name: "PeeringType", transform: extractValueFn},
		properties.EdgeLocation: {name: "EdgeLocation", transform: extractValueFn},
		properties.Owner:        {name: "OwnerAccountId", transform: extractValueFn},
		properties.Created:      {name: "CreatedAt", transform: extractTimeFn},
	},
}
