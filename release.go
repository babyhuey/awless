...
func buildAndZip(osname, arch string) error {
	...
	buildInfo := fmt.Sprintf("-X github.com/bootswithdefer/awless/config.buildDate=%s -X github.com/bootswithdefer/awless/config.buildSha=%s -X github.com/bootswithdefer/awless/config.buildOS=%s -X github.com/bootswithdefer/awless/config.buildArch=%s -X github.com/bootswithdefer/awless/config.BuildFor=%s",
