...
ElastiCache, EventBridge, Step Functions, WAF v2, AWS Config, Kinesis, Redshift, CodePipeline, CodeBuild, Elastic Beanstalk, Transit Gateway, VPC Endpoints, CodeDeploy, Glue, SES v2, Cognito, MSK and Amazon MQ have since been added and removed from the list, as were CloudTrail and CloudWatch Logs before them, along with EKS, DynamoDB, Secrets Manager, KMS, API Gateway v2, SSM and EFS. All of those are writable rather than list-only.

| Rank | Service | Resources | Complexity |
|------|---------|-----------|------------|
| 1 | FSx | file systems, volumes, backups | Low |
| 2 | Global Accelerator | accelerators, listeners, endpoint groups | Medium |
| 3 | VPC Peering* | peering connections | Low |
| 4 | Cloud Map | namespaces, services, instances | Low |
| 5 | AWS Backup | backup plans, vaults, recovery points | Low |
